...
public class ProductController {
   ...
   @GetMapping("products/{productName}")
     ...
     */
    @GetMapping("products/buy/{productName}/{sellerId}/{productQty}")
    public ResponseEntity<?> buyProduct(@PathVariable String productName,@PathVariable String sellerId,@PathVariable int productQty) throws Exception, ProductNotFoundException {

        Product buyedProduct=productService.buyProduct(productName,sellerId,productQty);
    ...
    public ResponseEntity<?> getAllOrderMapped() throws Exception {
        List<Order> retrieveOrders = orderService.mappedSeller();
        System.out.println("retrieved Orders"+retrieveOrders);
        return new ResponseEntity<>(retrieveOrders, HttpStatus.OK);
    }
